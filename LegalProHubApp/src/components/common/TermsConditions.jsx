...
const TermsConditions = () => {
  ...
  const isTermsVisible = useSelector((store) => store.logsignup.setTerms);
  const handleTerms = (e) => {
    e.preventDefault();
    navigate("/");
  };
  if (!isTermsVisible) return null;
  return (
    <div className={styles.terms}>
      <form className={styles.content} onSubmit={handleTerms}>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to LegalProHub.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to LegalProHub, accessible from{" "}
              <Link to="/" rel="external follow noopener">
                http://localhost:5173/
              </Link>
            </p>
          </li>
        ...
        <ul>
          <li>
            <p>By email: legalprohub@gmail.com</p>
          </li>
          <li>
            <p>
              By visiting this page on our website: [123 Justice ave, Suite 456,
              New York, NY 10001, USA](123 Justice ave, Suite 456, New York, NY
              10001, USA)
            </p>
          </li>
          <li>
            <p>By phone number: 03466509429</p>
          </li>
          <li>
            <p>By mail: 123 Justice ave, Suite 456, New York, NY 10001, USA</p>
          </li>
        </ul>
